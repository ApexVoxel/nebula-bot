...
PREFIX = '.'
YOUR_SERVER_IP = ''
MAIN_ADMIN_ID = '1489238655309582527'
VPS_USER_ROLE_ID = ''
...
def create_embed(title, description="", color=0x1a1a1a):
    ...
    embed.set_thumbnail(url="https://puny-amethyst-dx9clng4nc.edgeone.app/file_00000000bf1471faaab0bcedc34fb90d.png")
    embed.set_footer(text=f"{BOT_NAME} VPS Manager • {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}",
                     icon_url="https://puny-amethyst-dx9clng4nc.edgeone.app/file_00000000bf1471faaab0bcedc34fb90d.png")
    return embed
